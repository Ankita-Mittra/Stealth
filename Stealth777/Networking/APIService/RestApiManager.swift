...
//  Stealth777
//
//  Created by Fareed Alzoorani on 19/04/2022.
//
...
//
//    class func signup(parameters: [String: Any], completion: @escaping (_ data: [String: AnyObject]?, _ succeeded: Bool, _ error: String) -> Void) {
//
